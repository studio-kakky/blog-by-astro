    ...
    <header className={styles.header}>
      ...
      <div className={styles.description}>
        <p className={styles.description_p}>
          フリーランスエンジニア スタジオカッキーの雑記
        </p>
        <p className={styles.description_p}>
          エンジニアリングとか食とか釣りとか
        </p>
        <a className={styles.description_a} href="https://studio-kaky.com">
          https://studio-kaky.com
        </a>
      </div>
    </header>
  );
